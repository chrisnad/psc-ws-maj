...
namespace App\PhpAmqpLib\Wire;

use App\PhpAmqpLib\Exception\AMQPDataReadException;
use App\PhpAmqpLib\Exception\AMQPInvalidArgumentException;
use App\PhpAmqpLib\Exception\AMQPIOWaitException;
...
use App\PhpAmqpLib\Helper\MiscHelper;
...
class AMQPReader extends AbstractClient
{
    ...
    /** @var null|\App\PhpAmqpLib\Wire\IO\AbstractIO */
    protected $io;
