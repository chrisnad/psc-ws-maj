<?php
namespace App\PhpAmqpLib\Connection;

use App\PhpAmqpLib\Channel\AbstractChannel;
use App\PhpAmqpLib\Channel\AMQPChannel;
use App\PhpAmqpLib\Exception\AMQPConnectionClosedException;
use App\PhpAmqpLib\Exception\AMQPHeartbeatMissedException;
use App\PhpAmqpLib\Exception\AMQPInvalidFrameException;
use App\PhpAmqpLib\Exception\AMQPIOException;
use App\PhpAmqpLib\Exception\AMQPNoDataException;
use App\PhpAmqpLib\Exception\AMQPRuntimeException;
use App\PhpAmqpLib\Exception\AMQPSocketException;
use App\PhpAmqpLib\Exception\AMQPTimeoutException;
use App\PhpAmqpLib\Helper\Assert;
use App\PhpAmqpLib\Package;
use App\PhpAmqpLib\Wire;
use App\PhpAmqpLib\Wire\AMQPReader;
use App\PhpAmqpLib\Wire\AMQPTable;
use App\PhpAmqpLib\Wire\AMQPWriter;
use App\PhpAmqpLib\Wire\IO\AbstractIO;
...
abstract class AbstractConnection extends AbstractChannel
{
    ...
    /** @var \App\PhpAmqpLib\Wire\IO\AbstractIO */
    protected $io;

    /** @var \App\PhpAmqpLib\Wire\AMQPReader */
    ...
    /**
     * @return \App\PhpAmqpLib\Wire\IO\AbstractIO
     * @deprecated
     */
