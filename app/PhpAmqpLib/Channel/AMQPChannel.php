...
use App\PhpAmqpLib\Exception\AMQPBasicCancelException;
use App\PhpAmqpLib\Exception\AMQPChannelClosedException;
use App\PhpAmqpLib\Exception\AMQPConnectionBlockedException;
use App\PhpAmqpLib\Exception\AMQPConnectionClosedException;
use App\PhpAmqpLib\Exception\AMQPProtocolChannelException;
...
class AMQPChannel extends AbstractChannel
{
     ...
     * @param bool $auto_delete
     * @param bool $nowait
     * @param array|\App\PhpAmqpLib\Wire\AMQPTable $arguments
     * @param int|null $ticket
     * @return array|null
     *@throws \PhpAmqpLib\Exception\AMQPTimeoutException if the specified operation timeout was exceeded
     */
