<?php
namespace App\PhpAmqpLib\Channel;

use App\PhpAmqpLib\Connection\AbstractConnection;
use App\PhpAmqpLib\Exception\AMQPChannelClosedException;
use App\PhpAmqpLib\Exception\AMQPConnectionClosedException;
use App\PhpAmqpLib\Exception\AMQPInvalidFrameException;
use App\PhpAmqpLib\Exception\AMQPNoDataException;
use App\PhpAmqpLib\Exception\AMQPNotImplementedException;
use App\PhpAmqpLib\Exception\AMQPOutOfBoundsException;
use App\PhpAmqpLib\Exception\AMQPOutOfRangeException;
use App\PhpAmqpLib\Helper\DebugHelper;
use App\PhpAmqpLib\Helper\Protocol\MethodMap080;
use App\PhpAmqpLib\Helper\Protocol\MethodMap091;
use App\PhpAmqpLib\Helper\Protocol\Protocol080;
use App\PhpAmqpLib\Helper\Protocol\Protocol091;
use App\PhpAmqpLib\Helper\Protocol\Wait080;
use App\PhpAmqpLib\Helper\Protocol\Wait091;
use App\PhpAmqpLib\Message\AMQPMessage;
use App\PhpAmqpLib\Wire;
use App\PhpAmqpLib\Wire\AMQPReader;
...
abstract class AbstractChannel
{
     ...
     * @param \App\PhpAmqpLib\Wire\AMQPWriter|string $args
     */
     ...
     * @param array $method_sig
     * @param \App\PhpAmqpLib\Wire\AMQPWriter|string $args
     * @param \App\PhpAmqpLib\Wire\AMQPWriter $pkt
     * @return \App\PhpAmqpLib\Wire\AMQPWriter
     */
